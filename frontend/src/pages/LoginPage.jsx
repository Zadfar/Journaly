...
const LoginPage = () => {
	...
	const { session, signInUser, signInUserGoogle } = UserAuth();
	...
	return (
		...
		<div className="w-full max-w-md space-y-8">
			...
			<button
				type="submit"
				disabled={loading}
				className="group relative w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl text-white bg-[#228B22] hover:bg-[#008000] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#228B22] font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-200"
			>
				Login
			...
			<div className="text-center text-sm">
				<span className="text-[#2C4C3B]/60">Don't have an account yet? </span>
				<Link to={"/signup"}>
