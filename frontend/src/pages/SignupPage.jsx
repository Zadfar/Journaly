    ...
    return (
        ...
        <div className="w-full max-w-md space-y-8 animate-fade-in-up">
            ...
            <div className="text-center flex flex-col items-center">
                ...
                <h2 className="text-3xl font-bold tracking-tight mt-6 text-stone-800">Begin your journey</h2>
            ...
            <div className="bg-white p-8 sm:p-10 rounded-4xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-stone-100">
                ...
                <div className="relative my-7">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-4 bg-white text-stone-400 font-light">or continue with email</span>
                    </div>
                </div>
                ...
                <div className="space-y-1.5">
                    <label htmlFor="fullname" className="text-sm font-medium text-stone-700 ml-1">
                        Full Name
                    </label>
